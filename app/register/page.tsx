      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-border rounded-xl p-8 shadow-xl">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Join CyberSync today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button 
              type="submit" 
              className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold py-5 cyber-glow-sm mt-2"
              disabled={isLoading}
            >
